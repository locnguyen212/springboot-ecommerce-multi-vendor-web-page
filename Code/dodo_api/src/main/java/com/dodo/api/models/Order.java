...
public class Order implements java.io.Serializable {
	...
	public Order(User user, Shopowner shopowner, Date orderDate, Double totalAmount, String shippingAddress,
			String paymentMethod, String orderStatus, Date updatedAt, String paymentStatus, Set<Salesdata> salesdatas,
			Set<Orderdetail> orderdetails, Set<Invoice> invoices,
