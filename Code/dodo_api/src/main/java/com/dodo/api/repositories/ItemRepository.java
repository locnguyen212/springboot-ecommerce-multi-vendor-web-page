...
public interface ItemRepository extends JpaRepository<Item, Integer> {
	  ...
	  public Item findByProductIdAndUserId(@Param("productId") int productId, @Param("userId") int userId);
	 
	  //LOC
	  @Query("select new com.dodo.api.modelview.CartView(i.product.shopowner) "
				+ "from Item i "
