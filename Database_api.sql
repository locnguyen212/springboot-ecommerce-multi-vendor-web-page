...
(70, 4, 20, 1, '2023-12-02 12:45:40'),
(71, 4, 2, 1, '2023-12-02 12:45:40');
...
CREATE TABLE `user` (
  ...
  `ForgetPasswordToken` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(10, 'user5', '$2a$10$DYI7h.tKtc.Bo2UcM1nknO9FcFVZ/30ibTdcXUtM8byQr/tR35122', 'user5@example.com', 'Jane', 'Smith', '622 D. Cong Hoa Ward 13, Tan Binh, Ho Chi Minh City', '987-654-3210', 'http://localhost:9899/upload/3321e91675464a52a8f522b664d37beb.jpg', 'male', '1995-03-20', 1, 4, '2023-12-17 16:01:28', '2023-12-17 16:03:02', 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyNSIsImlhdCI6MTcwMjgyODk4NSwiZXhwIjoxNzAyODI5Mjg1fQ.qXhf2Eh-Iz-savT2mXb9ua7ZcdVTwqH8ZUFYv514wao', 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyNSIsImlhdCI6MTcwMjgyODk4NSwiZXhwIjoxNzAyODI5NTg1fQ.m5fbtTd3LwAC9Y7npb6C_btoJbtwlvIh6DCdh93Rs8k', NULL);
